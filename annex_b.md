# Anexo B (informativo): Relação entre os requisitos e desempenho funcional

## B.1 Relações entre as cláusulas 5 a 13 e os requisitos e desempenho funcional

A Tabela B.2 mostra quais os requisitos estabelecidos nas cláusulas 5 a 13 suportam cada desafio funcional estabelecido em 4.2.
Para que a Tabela B.2 encaixe na página, as abreviaturas usadas na Tabela B.1 foram usadas no cabeçalho das colunas da Tabela B.2.
...
4.2.6|WVC|Utilização sem capacidade vocal
4.2.7|LMS|Utilização com manipulação ou força limitada
4.2.8|LR|Utilização com alcance limitado
4.2.9|PST|Minimizar convulsões devido a fotossensibilidade
4.2.10|LC|Utilização com cognição limitada
4.2.11|P|Privacidade
...
5.1.3.2	Retorno auditivo incluindo fala|P|S|-|-|-|-|-|-|-|S|-
5.1.3.3	Correlação do retorno auditivo|-|P|-|-|-|-|-|-|-|S|-
5.1.3.4	Controlo através da fala|P|S|-|-|-|-|-|-|-|S|-
5.1.3.5	Interrupção automática da fala|P|S|-|-|-|-|-|-|-|S|-
5.1.3.6	Fala para conteúdo não textual|P|S|-|-|-|-|-|-|-|S|-
5.1.3.7	Fala para informação em vídeo|P|S|-|-|-|-|-|-|-|S|-
5.1.3.8	*Masked entry|P|S|-|-|-|-|-|-|-|S|P
5.1.3.9	Acesso privado a dados pessoais|P|S|-|-|-|-|-|-|-|S|P
5.1.3.10 Saída de áudio não interferente|P|S|-|-|-|-|-|-|-|S|-
5.1.3.11 Volume de audição privado|P|S|-|-|S|-|-|-|-|S|S
5.1.3.12 Volume do altifalante|P|S|-|-|-|S|-|-|-|S|-
5.1.3.13 Configuração do volume|P|S|-|-|S|-|-|-|-|S|-
5.1.3.14 Idiomas Falados|P|S|-|-|-|-|-|-|-|S|-
5.1.3.15 Identificação não visual de erro|P|S|-|-|-|-|-|-|-|S|-
5.1.3.16 Recibos, Multas e Saídas transacionais|P|S|-|-|-|-|-|-|-|-|-
5.1.4 Funcionalidade fechada à ampliação do texto|-|P|-|-|-|-|-|-|-|-|-	
5.1.5 Feeback visual para informação auditiva|-|-|-|P|P|-|-|-|-|S|-	
5.1.6.1	Operação sem a interface de teclado	(funcionalidade fechada)|P|P|-|-|-|S|P|-|-|-|-
5.1.6.2	Operação sem a interface de teclado	(foco de entrada)|P|P|-|-|-|S|P|-|-|-|-
5.2	Ativação dos recursos de acessibilidade|P|P|P|P|P|-|P|-|-|-|-
5.3	Biometria|P|P|-|P|-|P|P|P|-|-|P
5.4	Preservação das informações de acessibilidade durante a conversão|P|P|-|P|P|-|-|-|-|S|-
5.5.1 Modos de operação|-|-|-|-|-|-|P|-|-|-|-
5.5.2 Percepção das partes operáveis|P|S|-|-|-|-|-|-|-|-|-
5.6.1 Estado tátil ou auditivo|P|P|-|-|-|-|-|-|-|S|-
